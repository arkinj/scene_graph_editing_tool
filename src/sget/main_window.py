...
Minimal shell for the demo: 2D graph view as the central widget, layer panel
as a left dock, and a File menu for Open/Save/Quit.  The model is passed in
...
class MainWindow(QMainWindow):
    ...
    def _setup_menus(self, layer_dock: QDockWidget):
        # File menu.
